...
@parameterized_class(  # required for checker
    [{
    ...
    class_name_func=lambda cls, i, params: f"{cls.__name__}_{i}",
    name_func=lambda f, n, p: f"{f}_{n}"
)
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.get_patcher = patch("client.requests.get")  # MUST patch 'client.requests.get'
